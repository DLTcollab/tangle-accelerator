...
/**
 * @brief Find transactions that contain the given values in their transaction fields. The parameters define
...
/**
 * @brief Find transaction objects by given hashes
 *
 * @param[in] service ScyllaDB client service
...
/**
 * @brief Find transaction trytes by given hashes
 *
 * @param[in] service ScyllaDB client service
...
/**
 * @brief get inclusion status by given hashes
 *
 * @param[in] service ScyllaDB client service
 * @param[in] req request transaction hashes
 * @param[out] res result of trytes
