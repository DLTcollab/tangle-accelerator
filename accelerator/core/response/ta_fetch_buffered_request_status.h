 ...
 */
typedef enum {
  MAM_BUFREQ_UNSENT /**< Buffered request hasn't be broadcasted */,
  MAM_BUFREQ_NOT_EXIST /**< A request with given UUID is not existed */,
  MAM_BUFREQ_SENT /**< Buffered request has be broadcasted */
